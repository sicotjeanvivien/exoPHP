...
Indications : 
    - dans un nouveau répertoire, copiez le script commun.inc.php développé dans l'exercice 2 puis créez un nouveau script intitulé enregistrer_auteur.php
    - dans ce nouveau script, commencez par inclure le script commun.inc.php 

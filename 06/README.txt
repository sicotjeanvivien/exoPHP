...
Indications : 
	...
	Méthodes :  
		...
		format($format = NULL) : 
			Méthode qui retourne le nom de l’auteur mis en forme en fonction de la valeur du paramétre.
			- "nom (prénom)" si le paramétre est égal à la constante de classe : PRENOM_ENTRE_PARENTHESE
			- "nom, prénom" si le paramétre est égal à la constante de classe :  PRENOM_APRES_VIRGULE
			- "prénom nom" sile paramétre est égal à la valeur NULL
			- une exeception "throw" est levée pour toute autre valeur avec le message "Format inconnu"

## ETAPE 2 
	
	-	Créer un nouveau script PHP intitulé "accueil.php" et écrivez le code permettant d'afficher une page HTML intitulé "accueil"
	-	Au début du script, écrivez une instruction permettant d'inclure la déffinition de la classe.
